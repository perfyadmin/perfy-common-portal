...
// In production this would live in the backend; for now it's a single source of truth on the client.
...
// Admin auth (client-side gate; replace with real auth when the backend is wired).
